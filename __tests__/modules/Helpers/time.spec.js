// This test is not working because the new Date() could'n be mocked to a fixed date
// After a few days the test that are passing will failed
// All those lines was comment
